package question5337_find_the_longest_substring_containing_vowels_in_even_counts;
 ...
 *
 * 记录每个状态出现时的最小的索引，对于当前状态status，寻找之前出现过的该状态对应的字符串s的最小索引，
 * 这样才取得以j结尾的最长满足条件的字符串。
 *
